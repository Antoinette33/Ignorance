...
// Setting up all the necessary components
  ...
  var frontLight = new THREE.PointLight( 0xffffff, 0.45);
  frontLight.position.set(0, -200, -300 );
  scene.add( frontLight );

  var topLight = new THREE.PointLight( 0xffffff, 0.75);
...
//Now draw the floor and the ball
  ...
  function drawEyes(){
    ...
    var eyeMaterial = new THREE.MeshLambertMaterial({
      // eye color originally white -> light grey with the white background
...
// Creature Class contains all of the functions relevant to the actual ball
  function Creature(ix, iy, iz, ir){
    ...
    this.draw = function() {
      ...
      ballGuy.scale.set(2.5,3.25,2.5);
